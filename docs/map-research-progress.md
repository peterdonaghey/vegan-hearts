# Vegan Hearts Map — Research Progress

Region-by-region tracker for the Vegan Hearts Map dataset (`lib/places.ts`).
This file lives outside `.agents/skills/` so updates don't require skill-change approval.
Skill file updates are batched at the end of the project.
...
- `spainvegan.es` — now a casino/spam domain. Do NOT use.
- Working directories: madridvegano.es/santuarios-de-animales-en-espana, vlcanimalsave.org, elfuturoesvegano.com/es/mas-info/santuarios, associacioveganacatalunya.org/santuaris-refugis, xeu.cat (Catalan registry), guiavegana.net

## Skill updates pending (batch at the end)
