...
export const defaultGoodNews: GoodNewsItem[] = [
  // ── June 2026 ──
  {
    ...
    summary: "Farm Sanctuary shares six heartwarming photos of rescued farm animals — from goats and cows to pigs and chickens — living joyful, peaceful lives, reminding us that a kinder world for all creatures isn't just a dream, it's already taking shape.",
