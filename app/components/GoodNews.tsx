...
export const defaultGoodNews: GoodNewsItem[] = [
  // ── June 2026 ──
  {
    ...
    summary: "Farm Sanctuary shares six heartwarming photos of rescued farm animals — from gentle goats to contented cows — living joyfully in sanctuary, proving that a kinder world isn't just a distant dream, but one already taking shape through compassion in action.",
